    ...
    try:
        for index, data in enumerate(produits, start=1):
            ...
            try:
                ...
                # Association des 3 informations
                fournisseur = ", ".join([
                    str(informations_fournisseur).strip(),
                    str(fournisseur_nom).strip(),
        ...
        # =====================================
        # 9. Sauvegarde de tous les produits
        # =====================================
