...
Je développe une plateforme e-commerce appelée Founa, destinée principalement au marché ivoirien.



Je souhaite utiliser Alibaba.com comme source de produits pour ma plateforme.



Ton rôle sera de m'aider à rechercher et analyser des produits Alibaba afin de déterminer s'ils peuvent être intégrés à Founa.



Lorsque je te donne les liens des produits Alibaba, je veux que tu recherches toutes les informations disponibles et pertinentes sur ces produits un par un et le fournisseur.



Important : ne devine ou n'invente aucune information. Si une information n'est pas disponible, indique clairement "Non disponible".



Pour chaque produit, je souhaite obtenir les informations suivantes :
...
4. Informations sur le fournisseur
 ...
 Autres informations disponibles sur sa fiabilité 
...
6. Analyse pour Founa
 ...
 Informations importantes pour l'importation vers la Côte d'Ivoire 



Présente les résultats de manière structurée et facile à exploiter pour une plateforme e-commerce.



Maintenant, transforme les informations trouvées en fiche produit Founa.



Je veux obtenir un json pareil pour chacun des produits avec pour valeur les données recolter:
...
trousses
accessoires cheveux
accessoires de maquillage non réglementés